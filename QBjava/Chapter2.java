...
class students
{
    int id_no,number_of_subjects=6,total_credit=30,subject_credit=5;
    ...
    void Get_SubjectData(int n,int sub_code,String g_obt)
    {
       subject_code[n] = sub_code;
       grade_obt[n] = g_obt;
       
       if(grade_obt[n].endsWith("AA"))
       {
           grade_point[n]=10;
       }
       if(grade_obt[n].endsWith("AB"))
       {
           grade_point[n]=9;
       }
       if(grade_obt[n].endsWith("BB"))
       {
           grade_point[n]=8;
       }
       if(grade_obt[n].endsWith("BC"))
       {
           grade_point[n]=7;
       }
       if(grade_obt[n].endsWith("CC"))
       {
           grade_point[n]=6;
       }
       if(grade_obt[n].endsWith("CD"))
       {
           grade_point[n]=5;
       }
       if(grade_obt[n].endsWith("DD"))
       {
           grade_point[n]=4;
       }
       if(grade_obt[n].endsWith("FF"))
       {
           grade_point[n]=0;
       }
    }
    ...
    void Student_Details()
    {
        ...
        System.out.println();
        System.out.println("No of Subjects:"+number_of_subjects); 
        System.out.println("\tSub Code\tSub Credit\tGrade obtained");
        for(int i=0;i<number_of_subjects;i++)
        {
        System.out.println("\t"+subject_code[i]+"\t\t"+subject_credit+"\t"+grade_obt[i]);
        }
    }
    ...
    void calculate_spi()
    {
        ...
        for(int i=0;i<number_of_subjects;i++)
        {
            temp[i]=subject_credit*grade_point[i]; 
            ans=ans+temp[i]; 
            total_credits=subject_credit+total_credit;
        }
        spi=ans/total_credits; 
        System.out.println(ans+""+total_credits); 
    ...
    public static void main(String[] args)
    {
        ...
        for(int i=0;i<num;i++)
        {
            ...
            for(int j=0;j<6;j++)
            {
                ...
                s[i].Get_SubjectData(j,s_cod,s_gra);
            }
            s[i].Student_Details();
            s[i].calculate_spi();
        }
